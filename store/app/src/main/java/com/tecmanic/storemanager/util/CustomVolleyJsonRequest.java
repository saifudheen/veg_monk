...
//    public CustomVolleyJsonRequest(int post, String getStock, Map<String, String> params, Response.Listener<JSONObject> jsonObjectListener) {
//        super(post, getStock, params,errorListener);    }
